        ...
        <div class="body article_list">
            ...
            <Link to="/article/A-Potentially-Easier-Way-to-Calculate-the-Cross-Product">
                <div className="article-box">
                    ...
                    <p className="article-preview">
                        One of the first things I noticed after arriving in the
                        United States for college was how people write and
                        calculate math differently. Due to variations in
                        language, it is normal for people to write mathematical
                        expressions in different orders. For example, when
                        writing fractions, English speakers always write the
                        numerator first, followed by the denominator.
                    </p>
                </div>
            </Link>
        </div>
